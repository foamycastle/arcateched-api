...
import {modelNumberWithSearchMethodObject} from "../../validation/modelNumber";

interface extendRequest extends Request {
    validationResult: Joi.ValidationResult
}

export class findModelNumber extends MachineDataOp {
    ...
    validationHandler() {
        return (req: extendRequest, res: Response, next: NextFunction) => {
            ...
            req.validationResult = modelNumberWithSearchMethodObject().validate(req.body)
    ...
    queryPrep() {
        return (req: extendRequest, res: Response, next: NextFunction) => {
            ...
            this.queryObject.where.modelNumber[req.validationResult.value.searchMethod??"contains"]=req.validationResult.value.modelNumber
